...
function alterar(idvendedor){
    ...
    fetch("http://127.0.0.1:5555/vendedor/"+idvendedor)
    .then(resp => resp.json())
    .then(function(dados){
...
function salvar(){
    ...
    if (idvendedoratual > 0){
        url = "http://127.0.0.1:5555/vendedor/"+idvendedoratual;
        metodo = "PUT";

    } else{
        url = "http://127.0.0.1:5555/vendedor";
        metodo = "POST";
    }
...
function listar(){
    ...
    fetch("http://127.0.0.1:5555/vendedor")
    .then(resp => resp.json())
